...
from .models import Product_Details, Categories, posted_jobs, job_post_status, Order, bennar, contact_table, Subcategory, Discount_Coupon, blog_post, Blogs_Comments
...
def index(request):
    ...
    context2 = {'Product_Details_all':page, 'Categories_all':Categories_all, 'list':list, 'all_jobs':page2, 'page_num':page_num, 'bennar_all':bennar_all, 'bennar_first':bennar_first, 'page_num':page_num, 'all_latest_pst':all_latest_pst}
...
def product_search(request):
    ...
    all_latest_pst = blog_post.objects.order_by('-time')[:6]
    context5 = {'Product_Details_all':page, 'search_product':search_product, 'Categories_all':Categories_all, 'search_result_count':search_result_count, 'list1':list1, 'all_jobs':page2, 'page_num':page_num, 'all_latest_pst':all_latest_pst}
